	...
	public gyc_bus_dev_if
{
	...
	public:
		...
		void set_last_time_for_save(sc_time last) { m_last_time_for_save = last; }
		sc_time get_last_time_for_save() const { return m_last_time_for_save; }
		void set_last_time_for_load(sc_time last) { m_last_time_for_load = last;}
		sc_time get_last_time_for_load() const { return m_last_time_for_load; }
};
